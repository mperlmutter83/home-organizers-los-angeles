...
export const metadata: Metadata = {
  title: 'Leave a Review | Home Organizers Los Angeles',
  description: 'Leave Home Organizers Los Angeles a review on Google.',
};

const reviews = [
  {
    label: 'Leave a Google Review',
    href: 'https://g.page/r/CUMb9HVbn4_eEAE/review',
    kind: 'google',
  },
];
    ...
    <section className="bg-white py-20 md:py-28">
      <div className="mx-auto max-w-2xl px-4 text-center">
        ...
        <p className="mb-10 text-gray-600">
          Your feedback helps others find Home Organizers Los Angeles and helps
          us keep improving.
        </p>
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          {reviews.map((review) => (
            <a
              ...
              className="inline-flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-8 py-4 font-semibold text-gray-900 shadow-sm transition-shadow hover:shadow-md sm:w-auto"
            >
              <GoogleLogo />
              {review.label}
            </a>
